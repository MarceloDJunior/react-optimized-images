...
var Picture = function (_a) {
    ...
    var _b = React.useState(replaceExtension(src, 'webp')), imageSrc = _b[0], setImageSrc = _b[1];
    var _c = React.useState(false), hasError = _c[0], setHasError = _c[1];
    var onError = React__default["default"].useCallback(function () {
        if (!hasError) {
            setHasError(true);
            setImageSrc(src);
        }
    ...
    return (React__default["default"].createElement("picture", null,
        React__default["default"].createElement("source", { srcSet: imageSrc }),
        React__default["default"].createElement("img", __assign({ src: src, onError: onError }, props))));
};
